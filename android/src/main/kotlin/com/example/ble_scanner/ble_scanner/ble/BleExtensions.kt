...
const val BleExtensionTAG = "BleExtension"

// BluetoothGatt

fun BluetoothGatt.printGattTable() {
    if (services.isEmpty()) {
        Log.i(BleExtensionTAG,"No service and characteristic available, call discoverServices() first?")
        return
    }
    services.forEach { service ->
        ...
        Log.i(BleExtensionTAG,"Service ${service.uuid}\nCharacteristics:\n$characteristicsTable")
    }
}
